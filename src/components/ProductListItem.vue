  ...
  <article class="card">
    ...
    <div class="card__inner">
      ...
      <div class="card__buy">
        ...
        <button class="card__button" type="button" @click="addProduct(product)">
          <svg class="card__button-icon" width="17" height="20" viewBox="0 0 17 20" xmlns="http://www.w3.org/2000/svg">
            <path
